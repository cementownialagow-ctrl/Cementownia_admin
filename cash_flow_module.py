    ...
    def cash_flow():
        ...
        {% block content %}
          ...
          <div class="grid3">
            ...
            <div class="card"><h2>Zamówienia materiałów w drodze</h2><div style="font-size:24px;font-weight:800;">{{ "%.2f"|format(k.material_order_cost_est) }} PLN</div><div class="muted">{{ k.material_order_qty }} szt. wg cen zakupu szac. netto/2,5</div></div>
